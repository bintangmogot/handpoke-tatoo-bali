...
export default function TestimonialCard({
  ...
  return (
    <div className="flex flex-col bg-secondary rounded-lg overflow-hidden border border-border transition-all duration-300 hover:-translate-y-1 hover:border-border/80 group">
      {/* Top Image Area */}
